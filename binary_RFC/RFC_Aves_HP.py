...
# Save splits
df_train.to_csv('train_annotations_aves_2.csv', index=False)
df_valid.to_csv('valid_annotations_aves_2.csv', index=False)
...
train_df_with_features = pd.read_csv('train_annotations_aves_2.csv')
valid_df_with_features = pd.read_csv('valid_annotations_aves_2.csv') 
...
# Save classification report and accuracy to file
